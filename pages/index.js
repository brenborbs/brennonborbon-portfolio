      ...
      <article className="w-screen px-4" id="#projects">
        <div className="flex flex-col items-center justify-center border-t border-gray-300">
          ...
          <p className="my-4 mb-10 text-lg md:max-w-xl">
            Click on the tabs below to see my contribution to various
            professional projects. I am also open to contributing into
        ...
        <div className="container flex flex-wrap px-5 py-24 mx-auto sm:flex-nowrap">
          ...
          <div className="flex flex-col w-full mt-8 lg:w-1/3 md:w-1/2 md:ml-auto md:py-8 md:mt-0">
            ...
            <p className="mb-5 leading-relaxed text-gray-600">
              We can hop on and have a google meet or even skype to have a short
              chat and discuss interesting topics with regards to how I may be
              able to serve your projects.
            </p>
            <ContactForm />
          </div>
        </div>
